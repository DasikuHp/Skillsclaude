...
| GLoot          | github.com/peter-kish/gloot                    | GDScript         | Inventario universal (grid, stacks)   | 4.2+. Autor peter-kish (NO peter1745). AssetLib 1368. Importa solo addons/. |
| GUT            | github.com/bitwes/Gut                          | GDScript         | Unit testing por CLI                  | Serie 9.x = Godot 4.x. Usar si tests solo GDScript. |
| gdUnit4        | github.com/godot-gdunit-labs/gdUnit4           | GDScript + C#    | Testing GDScript+C#, mocking, JUnit XML | Usar si C#/mixto o quieres CI; GitHub Action: MikeSchulze/gdUnit4-action. |
